...
function About() {
  ...
  return (
    ...
    <img className='About_image' src='https://firebasestorage.googleapis.com/v0/b/profile-78495.appspot.com/o/horse%20play.jpeg?alt=media&token=beaf568b-7b6a-474e-be6d-3361859ebe47' alt='tumi'/>
